...
class SinglyLinkedList:
    ...
    #         temp_node = temp_node.next_node
    #         # at each loop
    #         # we can say temp_node = ll.head.next_node now points to Node(2)
    #         # we can say temp_node = ll.head.next_node.next_node now points to Node(3)
    #         # we can say temp_node = ll.head.next_node.next_node.next_node now points to None
    ...
    def append(self, node_value: T) -> None:
        ...
        while self.head.next_node is not None:
            ...
            # self.head = self.head.next_node
            # self.head = self.head.next_node.next_node
